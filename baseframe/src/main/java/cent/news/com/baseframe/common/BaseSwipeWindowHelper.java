package cent.news.com.baseframe.common;
...
public class BaseSwipeWindowHelper extends Handler {
    ...
    private static final int	SHADOW_WIDTH		= 50;					// px
    // 阴影宽度

    private static final int	EDGE_SIZE			= 20;					// dp
    // 默认拦截手势区间

    private int					mEdgeSize;									// px
    // 拦截手势区间
    ...
    class ViewManager {
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            if (mPreviousActivity instanceof BaseActivity && !((BaseActivity) mPreviousActivity).canBeSlideBack()) {
                mPreviousActivity = null;
                mPreviousContentView = null;
                return false;
            }

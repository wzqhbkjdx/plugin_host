...
public class BaseOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    public BaseOnScrollListener(BaseRefreshListener recyclerviewSKYRefreshListener) {
        this.recyclerviewSKYRefreshListener = recyclerviewSKYRefreshListener;
    }

    public void setRecyclerviewSKYRefreshListener(BaseRefreshListener recyclerviewSKYRefreshListener) {
        this.recyclerviewSKYRefreshListener = recyclerviewSKYRefreshListener;
    }

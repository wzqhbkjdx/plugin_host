...
public class StickyRecyclerHeadersTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public BaseStickyHeaders getAdapter() {
        if (mRecyclerView.getAdapter() instanceof BaseStickyHeaders) {
            return (BaseStickyHeaders) mRecyclerView.getAdapter();
        } else {
            throw new IllegalStateException("A RecyclerView with " + StickyRecyclerHeadersTouchListener.class.getSimpleName() + " requires a " + BaseStickyHeaders.class.getSimpleName());
        }
    }

...
import sky.cglib.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * SsaMethod}.
 * Stolen from {@link sky.cglib.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
     ...
     * {@link sky.cglib.dx.rop.type.TypeBearer} (such as a constant value).
     *
